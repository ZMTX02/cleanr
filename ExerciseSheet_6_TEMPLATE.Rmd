...
Das R-Paket `cleanr` stellt einfache Funktionen zur Datenbereinigung bereit, z. B. zum Entfernen von Zeilen mit fehlenden Werten und zur Vereinheitlichung von Spaltennamen. Diese Funktionalität ist nützlich in der Vorbereitung von Daten für Analysen und Modelle.
...
https://github.com/ZMTX02/cleanr
...
``` r
remotes::install_github("ZMTX02/cleanr")
```
